.class public Landroid/util/shendu/Lunar;
...
.field private oneToten:[Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/util/shendu/Lunar;->lunarInfo:[J
...
.method public constructor <init>(Ljava/util/Calendar;Landroid/content/Context;)V
    ...
    const-string/jumbo v17, "\u4e00"

    aput-object v17, v15, v16

    const/16 v16, 0x1

    const-string/jumbo v17, "\u4e8c"

    aput-object v17, v15, v16

    const/16 v16, 0x2

    const-string/jumbo v17, "\u4e09"

    aput-object v17, v15, v16

    const/16 v16, 0x3

    const-string/jumbo v17, "\u56db"

    aput-object v17, v15, v16

    const/16 v16, 0x4

    const-string/jumbo v17, "\u4e94"

    aput-object v17, v15, v16

    const/16 v16, 0x5

    const-string/jumbo v17, "\u516d"

    aput-object v17, v15, v16

    const/16 v16, 0x6

    const-string/jumbo v17, "\u4e03"

    aput-object v17, v15, v16

    const/16 v16, 0x7

    const-string/jumbo v17, "\u516b"

    aput-object v17, v15, v16

    const/16 v16, 0x8

    const-string/jumbo v17, "\u4e5d"

    aput-object v17, v15, v16

    const/16 v16, 0x9

    const-string/jumbo v17, "\u5341"

    aput-object v17, v15, v16

    move-object/from16 v0, p0

    iput-object v15, v0, Landroid/util/shendu/Lunar;->oneToten:[Ljava/lang/String;
    ...
    iput-object v0, v1, Landroid/util/shendu/Lunar;->mContext:Landroid/content/Context;

    .line 96
    move-object/from16 v0, p0

    iget-object v15, v0, Landroid/util/shendu/Lunar;->mContext:Landroid/content/Context;
    ...
    iput-object v15, v0, Landroid/util/shendu/Lunar;->chineseNumber:[Ljava/lang/String;
    ...
    iput-object v15, v0, Landroid/util/shendu/Lunar;->chineseDateFormat:Ljava/text/SimpleDateFormat;
    ...
    iget-object v15, v0, Landroid/util/shendu/Lunar;->chineseDateFormat:Ljava/text/SimpleDateFormat;
    ...
    invoke-direct {v0, v10}, Landroid/util/shendu/Lunar;->yearDays(I)I
    ...
    iput v10, v0, Landroid/util/shendu/Lunar;->year:I
    ...
    invoke-direct {v0, v10}, Landroid/util/shendu/Lunar;->leapMonth(I)I
    ...
    iput-boolean v15, v0, Landroid/util/shendu/Lunar;->leap:Z
    ...
    iget-boolean v15, v0, Landroid/util/shendu/Lunar;->leap:Z
    ...
    iget v15, v0, Landroid/util/shendu/Lunar;->year:I

    move-object/from16 v0, p0

    invoke-direct {v0, v15}, Landroid/util/shendu/Lunar;->leapDays(I)I
    ...
    invoke-direct {v0, v15, v9}, Landroid/util/shendu/Lunar;->monthDays(II)I
    ...
    iput v9, v0, Landroid/util/shendu/Lunar;->month:I
    ...
    iput v15, v0, Landroid/util/shendu/Lunar;->day:I
...
.method private cyclicalm(I)Ljava/lang/String;
    ...
    .prologue
    .line 80
    iget-object v2, p0, Landroid/util/shendu/Lunar;->mContext:Landroid/content/Context;
...
.method private leapDays(I)I
    ...
    .prologue
    .line 54
    invoke-direct {p0, p1}, Landroid/util/shendu/Lunar;->leapMonth(I)I
    ...
    .line 55
    sget-object v0, Landroid/util/shendu/Lunar;->lunarInfo:[J
...
.method private yearDays(I)I
    ...
    .line 47
    sget-object v2, Landroid/util/shendu/Lunar;->lunarInfo:[J
    ...
    .line 50
    :cond_1
    invoke-direct {p0, p1}, Landroid/util/shendu/Lunar;->leapDays(I)I
...
.method public animalsYear()Ljava/lang/String;
    ...
    .prologue
    .line 75
    iget-object v1, p0, Landroid/util/shendu/Lunar;->mContext:Landroid/content/Context;
    ...
    iget v1, p0, Landroid/util/shendu/Lunar;->year:I
...
.method public cyclical()Ljava/lang/String;
    ...
    .line 87
    .local v0, num:I
    invoke-direct {p0, v0}, Landroid/util/shendu/Lunar;->cyclicalm(I)Ljava/lang/String;
...
.method public getChinaDayString(ZI)Ljava/lang/String;
    .locals 6
    .parameter "md"
    .parameter "day"
    ...
    .line 157
    iget-object v3, p0, Landroid/util/shendu/Lunar;->mContext:Landroid/content/Context;
    ...
    iget-object v4, p0, Landroid/util/shendu/Lunar;->chineseNumber:[Ljava/lang/String;

    iget v5, p0, Landroid/util/shendu/Lunar;->month:I
    ...
    iget-object v4, p0, Landroid/util/shendu/Lunar;->oneToten:[Ljava/lang/String;
...
.method public toString(Z)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Landroid/util/shendu/Lunar;->animalsYear()Ljava/lang/String;
    ...
    iget-boolean v4, p0, Landroid/util/shendu/Lunar;->leap:Z
    ...
    iget v4, p0, Landroid/util/shendu/Lunar;->day:I

    invoke-virtual {p0, p1, v4}, Landroid/util/shendu/Lunar;->getChinaDayString(ZI)Ljava/lang/String;
