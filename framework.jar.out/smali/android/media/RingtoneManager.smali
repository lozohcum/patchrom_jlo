...
.method private getExternalMediaRingtones()Landroid/database/Cursor;
    .locals 7
    ...
    invoke-static {v4, v0}, Landroid/media/RingtoneManager;->constructBooleanTrueWhereClause(Ljava/util/List;Z)Ljava/lang/String;
...
.method public getExternalCursor()Landroid/database/Cursor;
    ...
    .local v0, drmCursor:Landroid/database/Cursor;
    :goto_1
    invoke-direct {p0}, Landroid/media/RingtoneManager;->getExternalMediaRingtones()Landroid/database/Cursor;
    ...
    .end local v2           #themeNotifCursor:Landroid/database/Cursor;
    .end local v3           #themeRegularCursor:Landroid/database/Cursor;
    :cond_1
    const/4 v0, 0x0
