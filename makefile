#
# Makefile for sony xperia J; jlo
#
...
local-out-zip-file := MIUI_jlo.zip
...
local-phone-apps:= Gallery2 LatinIME

# All apks from MIUI
local-miui-removed-apps := Weather

local-miui-modified-apps := Phone Settings ThemeManager
